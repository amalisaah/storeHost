...
const  Logo = (props)=> {
    ...
    return (
        ...
        <div className={"logo text-2xl text-bg "+ props.className } style={props.style ? props.style.col : {}}><h2 id='logo' onBlur={props.onBlur} contentEditable={props.template} suppressContentEditableWarning className="text-inherit">{props.logo}</h2> </div>
    )
};
