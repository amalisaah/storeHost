                ...
                <div className='px-[5.5%] py-8'>
                    <div className='flex justify-between'>
                        <div className='flex flex-col justify-center w-[43.4%]'>
                            <h2 id='businessHeader2'className="font-bold text-[45px] leading-[62.74px] text-black">{edit.businessHeader2}</h2>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div className='flex flex-col justify-center w-[43.4%]'>
                            <h2 id="businessHeader3" className="font-bold text-[45px] leading-[62.74px] text-black">{edit.businessHeader3}</h2>
